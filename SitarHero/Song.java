...
public class Song { 
    ...
    public Song (String t) { // pass in title of song
        ...
        audioFile = Files.getFile(this, "files/" + t + "/" + t + ".wav");
        infoFile = Files.getFile(this, "files/" + t + "/" + t + ".txt");
        notesFile = Files.getFile(this, "files/" + t + "/" + t + "_notes.txt");
        keysFile = Files.getFile(this, "files/" + t + "/" + t + "_keys.txt");
