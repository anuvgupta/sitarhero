...
public class Note extends JComponent { // declare Note class as a type of JComponent
    ...
    public void paintComponent(Graphics g) { // paintComponent method overrides method in JComponent
        if (string < 6) { // if the note is not a blank note
            ...
            if (yPos >= 485)
                g2.setColor(color.darker().darker().darker()); // if the note has already been missed, darken color a lot
            ...
            if (yPos >= 485)
                g2.setColor(color.darker().darker().darker().darker()); // if the note has already been missed, darken color a lot
