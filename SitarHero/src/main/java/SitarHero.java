...
public class SitarHero extends JPanel { // declare Engine class as a type of JPanel
    ...
    public SitarHero() { // Engine constructor
        ...
        title.setFont(new Font("Helvetica", Font.PLAIN, 38));
        ...
        Font infoFont = new Font("Helvetica", Font.PLAIN, 12);
        ...
        String[] infoText = new String[]{"<div style = 'font-size: 23'>Welcome to Sitar Hero!</div>",
                ...
                "<div style = 'font-size: 14'><i>PRESS SPACE TO START</i></div>"};
    ...
    public static void main(String... args) throws IOException {
        final SitarHero e = new SitarHero(); // construct new Engine
        final JFrame f = new JFrame("Sitar Hero"); // construct new JFrame
        // initialize JFrame size and properties
        f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // force program exit on frame close
        f.setSize(400, 582); // set size of frame to 400x562
        f.setResizable(false); // force the frame to be rigid in size
        f.setLocationRelativeTo(null);

        final Game game = new Game(); // construct new Game (game management) JPanel object
