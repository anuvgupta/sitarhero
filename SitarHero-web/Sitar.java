...
public class Sitar {
    ...
    public Sitar() {
        ...
        InputStream file = Sitar.class.getClassLoader().getResourceAsStream("files/sitar/saz.SF2"); // load soundfont into file
        try {
            sitarSB = MidiSystem.getSoundbank(new BufferedInputStream(file)); // load soundbank from soundfont file into custom soundbank file
